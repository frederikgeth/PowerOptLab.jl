...
makedocs(
    ...
    pages = [
        ...
        "Function formulations" => [
            ...
            "Mathematics and analytic reference" => "formulations/theory.md",
        ...
        "Electric vehicle charging" => [
            ...
            "Equipment, energy and sessions" => "ev/sessions.md",
            "Workplace feeder study" => "ev/workplace.md",
            "Artificial cycling and arbitrage" => "ev/modes.md",
            "CCOpt zero-dispatch investigation" => "ev/ccopt_investigation.md",
            "Taper, smoothing and flexibility" => "ev/approximations.md",
            "Literature evidence" => "ev/literature.md",
            "Scope and research roadmap" => "ev/roadmap.md",
            "EV and storage API" => "ev/api.md",
            "Compatibility and migration" => "ev/migration.md",
        ],
        "Component models" => [

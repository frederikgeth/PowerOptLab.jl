...
Items 7-8 are the next sources for replacing the constant `i_sw` reserve with an
operating-point-dependent switching-ripple model. Items 5-6 remain validation
anchors for unequal half-bank dynamics, active balancing, and improved voltage
utilisation beyond the present steady-state charge abstraction.

## Filters, impedance, and frequency coupling

9. **M. Liserre, F. Blaabjerg, and S. Hansen**, “Design and control of an LCL-
   ...
   formula. PowerOptLab implements the passive circuit at the fundamental
   frequency, not the paper's control-design or stability layer.
10. **J. Sun**, “Impedance-based stability criterion for grid-connected
...
11. **A. Rygg, M. Molinas, C. Zhang, and X. Cai**, “A modified sequence-domain
...
Items 10-11 define a separate future model layer: frequency-dependent
...
13. **C. J. O'Rourke, M. M. Qasim, M. R. Overlin, and J. L. Kirtley**, “A
...
14. **Y. Lin et al.**, *Research Roadmap on Grid-Forming Inverters*,
    NREL/TP-5D00-73476, 2020.
    [NREL report](https://www.nrel.gov/docs/fy21osti/73476.pdf).
15. **S. Shah and D. Ramasubramanian**, *Testing the Performance of Grid-Forming
...
Items 14-15 are guardrails on terminology and validation: a steady-state balanced
...
- zero-sequence/common-mode filter and grounding models, including mutual
  inductance and neutral inductors;
- modulation-specific closed forms with dead time and overmodulation;

...
- a runnable `scripts/run_post_opf_operability_study.jl` fixture now exercises
  constant-power/ZIP model ensembles plus an unbalanced DELTA case, named
  loading directions, connection-aware fixed-point margins, and table-ready
  snapshot output with finite-study assertions;
